...
public class ChangeOrg extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (exiud.execSql("D_ORG", exeInsertUpdateDelete.UPDATE, hs)) {
		...
		response.sendRedirect("../OrgNodeManage.jsp?uid=" + hs.get("ORG_ID") + "&issuccess=" + issuccess);
	}
